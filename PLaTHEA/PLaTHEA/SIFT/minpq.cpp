...
{
	struct min_pq* min_pq_p;

	min_pq_p = (min_pq *) malloc( sizeof( struct min_pq ) );
	min_pq_p->pq_array = (pq_node *) calloc( MINPQ_INIT_NALLOCD, sizeof( struct pq_node ) );
	min_pq_p->nallocd = MINPQ_INIT_NALLOCD;
	min_pq_p->n = 0;
