...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2018-11-15T15:23:40.200Z[GMT]")public class IdentityApiServiceImpl extends IdentityApiService {
    @Override
    public Response addIdentity(Body6 body, SecurityContext securityContext) throws NotFoundException {
    ...
    @Override
    public Response updateIdentity(Body5 body, Integer identityID, SecurityContext securityContext) throws NotFoundException {
