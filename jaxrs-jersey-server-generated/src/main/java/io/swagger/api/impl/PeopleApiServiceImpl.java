...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2018-11-15T15:23:40.200Z[GMT]")public class PeopleApiServiceImpl extends PeopleApiService {
    @Override
    public Response getAllPeople(SecurityContext securityContext) throws NotFoundException {
        MainSystem.ReturnPeopleMessage ret = MainSystem.getPeople();
