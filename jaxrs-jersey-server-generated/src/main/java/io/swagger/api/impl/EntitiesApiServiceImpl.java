...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2018-11-15T15:23:40.200Z[GMT]")public class EntitiesApiServiceImpl extends EntitiesApiService {
    @Override
    public Response getAllPositions(SecurityContext securityContext) throws NotFoundException {
        MainSystem.ReturnEntitiesMessage ret = MainSystem.getAllPositions();
