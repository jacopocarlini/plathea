...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2018-11-18T18:02:56.242Z[GMT]")public class IdentityApi  {
   ...
   public IdentityApi(@Context ServletConfig servletContext) {
    ...
    public Response addIdentity(@Parameter(description = "The name and the surname of the Identity to create." ,required=true) Body8 body
...
,@Context SecurityContext securityContext)
    ...
    public Response updateIdentity(@Parameter(description = "Identity that needs to be modified" ,required=true) Body7 body
